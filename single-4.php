			...
			<div class="pan"><a href="index.html"><span class="blue">home</span></a> &gt; <a href="about_program.html"><span class="pink">体験プログラム:医療事務</span></a></div>
	<div class="pro_waku_top">
		<h2><img src="<?php bloginfo('template_url'); ?>/image/jimu_iryou_h2.png" width="449" height="57" alt="見出し：医療事務体験プログラム" /></h2>
				<!-- pro_waku_top --></div>
		<div class="pro_waku_middle">
			<div id="content21">
			<div id="content22">
			<div id="content23">
				<img src="<?php bloginfo('template_url'); ?>/image/jimu_iryou1.png" width="135" height="138" alt="医療事務の画像" />
				<p>病院における患者さんの受付業務からカルテの管理、診療報酬明細書（レセプト）の作成、会計を行うなど多岐にわたる。
					レセプトの作成は医療機関の事務において非常に重要な業務であり、
					この業務の精度と効率をあげるために医療事務の各種資格が求められる。
					事務処理だけでなく患者さんとのコミュニケーションも求められる仕事。</p>	
			</div>
				<div class="hoikusi-content">
			<div id="content26">
				<p><?php echo get_post_meta($post->ID,'カレンダー', true); ?>(<?php echo get_post_meta($post->ID,'曜日', true); ?>)　　医療事務体験プログラム　　　<?php echo get_post_meta($post->ID,'場所', true); ?></p>
			</div>
			<div id="content24">
