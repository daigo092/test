				...
				<?php while ( have_posts() ) : the_post(); ?>
						<div class="pan"><a href="index.html"><span class="blue">home</span></a> &gt; <a href="about_program.html"><span class="pink">体験プログラム:ブライダル関連専門職</span></a></div>
	<div class="pro_waku_top">
		<h2><img src="<?php bloginfo('template_url'); ?>/image/hospital_h2.png" width="689" height="59" alt="見出し：ブライダル関連専門職" /></h2>
				<!-- pro_waku_top --></div>
		<div class="pro_waku_middle">
			<div id="content21">
			<div id="content22">
			<div id="content23">
				<img src="<?php bloginfo('template_url'); ?>/image/hospital1.png" width="135" height="138" alt="ブライダル関連専門職" />
		<p>ウエディングプランナーなどブライダルの世界で働く上で資格は必須ではない。
					しかし、業界で就業する前にウエディングプランナーの仕事や業界を理解するための学びの機会は幾つか用意されている。ブライダル業界に関する知識、結婚式・披露宴に関する知識、
					結婚式・披露宴の演出に関する知識、接客・コミュニケーションについての知識など学べることは多く、
					ブライダル業界を目指す人は何らかの資格取得を目指すケースも多い。</p>	
			</div>
				<div class="hoikusi-content">
			<div id="content26">
				<p><?php echo get_post_meta($post->ID,'カレンダー', true); ?>(<?php echo get_post_meta($post->ID,'曜日', true); ?>)ブライダル関連専門職体験プログラム　　<?php echo get_post_meta($post->ID,'場所', true); ?></p>
			</div>
			<div id="content24">
