			...
			<div class="pan"><a href="index.html"><span class="blue">home</span></a> &gt; <a href="about_program.html"><span class="pink">体験プログラム:プログラマー</span></a></div>
	<div class="pro_waku_top">
		<h2><img src="<?php bloginfo('template_url'); ?>/image/programmer_h2.png" width="529" height="58" alt="見出し：プログラマー体験プログラム" /></h2>
				<!-- pro_waku_top --></div>
		<div class="pro_waku_middle">
			<div id="content21">
			<div id="content22">
			<div id="content23">
				<img src="<?php bloginfo('template_url'); ?>/image/programmer1.png" width="135" height="138" alt="プログラマーの画像" />
<p>WEBサイトの構築や更新、一部保守メンテを行う仕事。専門のシステム会社だけでなく、一般的な企業でもプログラマーを雇用するケースが増えてきている。
WordPressなど専門知識をそれほど持たなくても簡易なサイト制作や顧客管理ができるようになったことがその背景。デザイナーとともに「インハウス・プログラマー」
というポジションで人材活用されるケースが見込まれつつある。</p>	
			</div>
				<div class="hoikusi-content">
			<div id="content26">
				<p><?php echo get_post_meta($post->ID,'カレンダー', true); ?>(<?php echo get_post_meta($post->ID,'曜日', true); ?>)　プログラマー体験プログラム　　<?php echo get_post_meta($post->ID,'場所', true); ?></p>
			</div>
			<div id="content24">
