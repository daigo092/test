			...
			<div class="pan"><a href="index.html"><span class="blue">home</span></a> &gt; <a href="about_program.html"><span class="pink">体験プログラム:保育士</span></a></div>
<div class="pro_waku_top">
		<h2><img src="<?php bloginfo('template_url'); ?>/image/h2_5.png" width="410" height="59" alt="見出し：保育士体験プログラム" /></h2>
				<!-- pro_waku_top --></div>
	<div class="pro_waku_middle">
				<div id="content21">
			<div id="content22">
			<div id="content23">
				<img src="<?php bloginfo('template_url'); ?>/image/hoiku1.png" width="135" height="138" alt="保育士の画像" />
				<p>都道府県知事の登録を受け、保育士の名称を用いて、専門的知識及び技術をもって、児童の保育及び児童の保護者に対する保育に関する指導を行うこと仕事。
子供の成長を支援するだけでなく、育児を行う保護者の支えやアドバイザーとしての活躍も期待される。</p>	
			</div>
			<div class="hoikusi-content">
			<div id="content26">
				<p><?php echo substr(get_post_meta($post->ID,'カレンダー', true),5); ?>(<?php echo get_post_meta($post->ID,'曜日', true); ?>)　保育士体験プログラム　　<?php echo get_post_meta($post->ID,'場所', true); ?></p>
			</div>
			<div id="content24">
