			...
			<div class="pan"><a href="index.html"><span class="blue">home</span></a> &gt; <a href="about_program.html"><span class="pink">体験プログラム:WEBデザイナー</span></a></div>
	<div class="pro_waku_top">
		<h2><img src="<?php bloginfo('template_url'); ?>/image/web_designer_h2.png" width="576" height="57" alt="見出し：webデザイナー体験プログラム" /></h2>
				<!-- pro_waku_top --></div>
		<div class="pro_waku_middle">
			<div id="content21">
			<div id="content22">
			<div id="content23">
				<img src="<?php bloginfo('template_url'); ?>/image/web_designer.png" width="135" height="138" alt="webデザイナーの画像" />
		<p>WEBサイトやWEB上のメディアを形成するデザイン制作に携わる仕事。専門学校や職業訓練校で学んだ
					IllustratorやPhotoshop活用技術が活かされることが多い。
					デザイン事務所や広告代理店などの需要が一般的ではあるが、
					近年、様々な業界でデザイナーの活用を模索するケースが増えている。
					その場合、自社サイトの更新、自社広報物の作成などにあたる。
					デザイン重視企業になるとインハウス・デザイナー（自社デザイナー）を抱えブランド構築や
					広報に人材活用を行う場合もある。</p>
			</div>
				<div class="hoikusi-content">
			<div id="content26">
				<p><?php echo get_post_meta($post->ID,'カレンダー', true); ?>(<?php echo get_post_meta($post->ID,'曜日', true); ?>)　WEBデザイナー体験プログラム　　<?php echo get_post_meta($post->ID,'場所', true); ?></p>
			</div>
			<div id="content24">
